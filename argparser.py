...
def get_argparser():
    ...
    parser.add_argument("--epochs", type=int, default=None,
                        help="epoch number (default: None)\n")
    ...
    # Parameters for Memory Contrast
    parser.add_argument("--temperature", default=0.1, type=float,
                        help='temperature for contrast (Def 0.1)')
    parser.add_argument("--base_temperature", default=0.07, type=float,
                        help='base temperature for contrast (Def 0.1)')
    parser.add_argument("--contrast_weight", default=0.1, type=float,
                        help='wight for mem contrast (Def 0.1)')
    parser.add_argument("--warm_epoch", default=4, type=int,
                        help='warm_epoch mem contrast (Def 4)')
    parser.add_argument("--pixel_size", default=5000, type=int,
                        help='pixel mem queue size (Def 5000)')
    parser.add_argument("--region_size", default=5000, type=int,
                        help='region mem queue size (Def 5000)')
    parser.add_argument("--num_pos", default=1024, type=int,
                        help='number of positive samples (Def 1024)')
    parser.add_argument("--num_neg", default=2048, type=int,
                        help='number of negative samples (Def 2048)')
    parser.add_argument("--pixel_update_freq", default=10, type=int,
                        help='number of pixels update frequence when step > 0 (Def 10)')
    return parser
