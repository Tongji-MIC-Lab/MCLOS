        ...
        for ii in range(batch_size):
            ...
            for cls_id in this_classes:
                ...
                if num_hard >= n_view / 2 and num_easy >= n_view / 2:
                    ...
                    self.logger.info(f"this shoud be never touched! {num_hard} {num_easy} {n_view}")
                    raise Exception
...
class ContrastLoss(nn.Module, ABC):
    ...
    def forward(self, seg, embedding, target, cur_epoch=None):
